...
class StampsControllerTest < ActionController::TestCase
  ...
  test "should create stamp" do
    assert_difference('Stamp.count') do
      post :create, stamp: { code: @stamp.code, expires_at: @stamp.expires_at, user_id: @stamp.user_id, valid: @stamp.valid }
    end
  ...
  test "should update stamp" do
    put :update, id: @stamp, stamp: { code: @stamp.code, expires_at: @stamp.expires_at, user_id: @stamp.user_id, valid: @stamp.valid }
    assert_redirected_to stamp_path(assigns(:stamp))
  end
